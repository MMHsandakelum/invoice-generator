...
const getEditData = async () => {
    let response = await axios.get("/api/get_edit_data/" + props.id);
    console.log("res : ", response);
    form.value = response.data.formData;
    addAllCart(response.data.formData.items);
};
...
const onSave = () => {
    ...
    axios.post("/api/update_invoice", formData);
    listCart.value = [];
